...
const variants = {
  ...
  primary:
    'py-4 px-6 bg-primary-dark lg:hover:bg-primary text-white font-bold transition-all duration-200 ease-in-out  focus:ring-3 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary/60 disabled:opacity-50',
};
