...
ReviewSchema.post('save', function () {
  // @ts-expect-error: Explanation: TypeScript cannot infer the type of 'this' in Mongoose schema hooks and methods, so we use @ts-expect-error to suppress the error.
